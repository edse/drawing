console.log('\'Allo \'Allo! from main');
...
Tool.prototype.update = function() {
  ...
  */
  ...
  if(this.selected_tool == 0){
    ...
    if(this.selectedBody && this.isMouseDown){
      if(this.building==null)
        this.building = {type:"point", x1:this.mouseX, y1:this.mouseY, x2:this.mouseX, y2:this.mouseY, built: false};
      else{
        ...
        this.selectedBody.SetPosition(new b2Vec2(this.selectedBody.GetPosition().x + dx, this.selectedBody.GetPosition().y + dy));
        this.building.x1 = this.mouseX;
        this.building.y1 = this.mouseY;
      }
    }else{
      this.building = null;
      this.center.x = this.selectedBody.GetPosition().x;
